...
Честный ответ: **у автора очень, очень слабое железо**. Tauri требует Rust-тулчейн, который компилируется долго и ест память. Electron собирается быстрее, работает «из коробки» и документирован лучше. Если у вас есть навыки Rust и желание портировать — welcome to issues.
...
- **Морально** — звезда ⭐ на GitHub, расшаривание друзьям, доброе слово или рекомендация в issues
